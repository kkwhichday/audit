package org.claim.audit.vacation.service.impl;
...
public class VacationServiceImpl implements VacationService{
    ...
    private static final String PROCESS_DEFINE_KEY = "vacation2Process";
    ...
    public Object startVac(String userName, Vacation vac) {
       ...
       leaderList.add("managera");
       leaderList.add("managerb");
       leaderList.add("managerc");
    ...
    //走第二种springbean分配任务的方式vacation2Process
...
//	        taskList.addAll(list);
    ...
    public Object myVacRecord(String userName) {
        ...
        for (HistoricProcessInstance hisInstance : hisProInstance) {
            ...
            taskHelperService.setVars(vacation, varInstanceList);
